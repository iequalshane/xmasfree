...
;==============================================================
	...
	dc.b	"SHANE.          "                                 ; Copyright holder and release date
	dc.b	"XMASFREE                                        " ; Domestic name
	dc.b	"XMASFREE                                        " ; International name
...
;==============================================================
	...
	; Game sources
	include "src/xmasfree/main.asm"		; Entry point into the program
	include "src/shared/intro.asm"		; The first scene with Shane logo
	include "src/xmasfree/game.asm"		; The actual gameplay

	; Content. Best at end of file due to the large content size.
	include "src/xmasfree/content.asm"
